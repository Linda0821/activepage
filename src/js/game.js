...
/*时间参数*/
var loginTime = new Date("2019-03-15 00:00:00");//定义新朋友注册时间
var startTime = new Date("2019-03-15 00:00:00").getTime();
...
function pcInitUmeUser(callback) {
  var token = "fec71e00089cbba0",
    objectId = "ffbf4e5c8b525409e74fed8c";
  UMeUser.initUser(token, objectId).then(function (init_user) {
    debug_print("linitUser user: " + JSON.stringify(init_user));
    postDid(init_user.InviteCode)
    callback(init_user);
